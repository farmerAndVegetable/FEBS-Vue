...
82
1,732635wuyouzhuguli/FEBS-Vue
 Code Issues 16 Pull requests 0 Actions Projects 0 Wiki Security Insights
FEBS-Vue/sql/febs.sql
@wuyouzhuguli wuyouzhuguli '调整SQL'
65d6bd1 on 1 Aug
@wuyouzhuguli@iiiron
908 lines (863 sloc)  69.7 KB
...
----增加了findMenuChildren函数
CREATE FUNCTION findMenuChildren (orgid INT)
...
SELECT GROUP_CONCAT(menu_id) INTO oTempChild FROM t_menu WHERE FIND_IN_SET(parent_id,oTempChild) > 0;
END WHILE;
RETURN oTemp;
END
